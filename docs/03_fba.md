...
*Saccharomyces cerevisiae*, a widely used model organism in eukaryotic studies, has long been used to study genetic interactions, build cell factories for the production of high-value-added compounds, and comprehend eukaryotic metabolism. The genome-scale metabolic models (GEMs) of *S. cerevisiae* have undergone 20 years of iterative refinement and enhancement including Yeast9 {cite:p}`yeast9`, Yeast8 {cite:p}`yeast8`,  Yeast7 {cite:p}`yeast7`, Yeast5 {cite:p}`yeast5`, Yeast4 {cite:p}`yeast4`, iMM904 {cite:p}`imm904`, iIN800 {cite:p}`iin800`, iLL672 {cite:p}`ill672`, iND750 {cite:p}`ind750` since the initial publication of the first-generation model, iFF708, in 2003 {cite:p}`iff708`. 
